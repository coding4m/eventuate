...
lazy val root = (project in file("."))
  .aggregate(core, crdt, logCassandra, logLeveldb, logRocksdb, logAdapter, snapshotCassandra, snapshotLeveldb, snapshotRocksdb, adapterStream)
  //  .aggregate(core, crdt, logCassandra, logLeveldb, adapterStream, adapterVertx, examples, exampleStream, exampleVertx)
  .dependsOn(core, logCassandra, logLeveldb, logRocksdb, logAdapter, snapshotCassandra, snapshotLeveldb, snapshotRocksdb, adapterStream)
...
lazy val snapshotCassandra = (project in file("eventuate-snapshot-cassandra"))
  .dependsOn(core % "compile->compile;it->it;multi-jvm->multi-jvm")
  .settings(name := "eventuate-snapshot-cassandra")
  .settings(commonSettings: _*)
  .settings(integrationTestSettings: _*)
  .settings(libraryDependencies ++= Seq(AkkaRemote, CassandraDriver))
  .settings(libraryDependencies ++= Seq(AkkaTestkit % "test,it", AkkaTestkitMultiNode % "test", Log4jApi % "test,it", Log4jCore % "test,it", Log4jSlf4j % "test,it", Scalatest % "test,it", Sigar % "test,it"))
...
lazy val snapshotLeveldb = (project in file("eventuate-snapshot-leveldb"))
  .dependsOn(core % "compile->compile;it->it;multi-jvm->multi-jvm")
  .settings(name := "eventuate-snapshot-leveldb")
  .settings(commonSettings: _*)
  .settings(integrationTestSettings: _*)
  .settings(libraryDependencies ++= Seq(AkkaRemote, Leveldb))
  .settings(libraryDependencies ++= Seq(AkkaTestkit % "test,it", AkkaTestkitMultiNode % "test", Scalatest % "test,it"))
...
lazy val snapshotRocksdb = (project in file("eventuate-snapshot-rocksdb"))
  .dependsOn(core % "compile->compile;it->it;multi-jvm->multi-jvm")
  .settings(name := "eventuate-snapshot-rocksdb")
  .settings(commonSettings: _*)
  .settings(integrationTestSettings: _*)
  .settings(libraryDependencies ++= Seq(AkkaRemote, Rocksdb))
  .settings(libraryDependencies ++= Seq(AkkaTestkit % "test,it", AkkaTestkitMultiNode % "test", Scalatest % "test,it"))
