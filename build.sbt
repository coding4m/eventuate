...
lazy val root = (project in file("."))
  .aggregate(core, crdt, logCassandra, logLeveldb, logRocksdb, adapterSpark, adapterStream)
  //  .aggregate(core, crdt, logCassandra, logLeveldb, adapterStream, adapterVertx, examples, exampleStream, exampleVertx)
  .dependsOn(core, logCassandra, logLeveldb, logRocksdb, adapterSpark, adapterStream)
...
//    .settings(protocSettings: _*)
  ...
  .settings(libraryDependencies ++= Seq(AkkaContrib, AkkaCluster, AkkaRemote, CommonsIo, Java8Compat, Scalaz, Protobuf))
