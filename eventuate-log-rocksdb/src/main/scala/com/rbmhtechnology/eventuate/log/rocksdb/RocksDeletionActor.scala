...
private object RocksDeletionActor {
  ...
  def props(
    ...
    Props(new RocksDeletionActor(rocksdb, rocksdbReadOptions, rocksdbWriteOptions, columnHandle, batchSize, toSequenceNr, promise))
}
private class RocksDeletionActor(
  val rocksdb: RocksDB,
