...
object MessagePipeline {
  ...
  private[MessagePipeline] case class InnerAndAfter(transformedMsg: Any, after: Unit => Unit) extends Delegation
 ...
 */
trait MessagePipeline extends Actor {
  import MessagePipeline._
