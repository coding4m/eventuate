...
object ReplicationEndpoint {
  ...
  def apply(logFactory: String => Props, connections: Set[ReplicationConnection], connectionRoles: Set[String])(implicit system: ActorSystem): ReplicationEndpoint = {
    ...
    new ReplicationEndpoint(endpointId, Set(ReplicationEndpoint.DefaultLogName), logFactory, connections, connectionRoles, applicationName = applicationName, applicationVersion = applicationVersion)(system)
  }
